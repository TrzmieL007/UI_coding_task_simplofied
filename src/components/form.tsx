...
import '../App.css';
import {Category, Coordinator} from "../app-types";
...
class Form extends React.Component<FormProps,FromState> {
...
export default connect((state:any):any=>({ formState : state.formState }))(Form);